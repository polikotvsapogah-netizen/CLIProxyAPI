...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.PATCH("/account-pools/:id", s.mgmt.PatchAccountPool)
		mgmt.DELETE("/account-pools/:id", s.mgmt.DeleteAccountPool)
		mgmt.GET("/client-access", s.mgmt.GetClientAccess)
		mgmt.PUT("/client-access", s.mgmt.PutClientAccess)
		mgmt.PATCH("/client-access/:id", s.mgmt.PatchClientAccess)
		mgmt.DELETE("/client-access/:id", s.mgmt.DeleteClientAccess)
		mgmt.GET("/generic-secrets", s.mgmt.GetGenericSecrets)
		mgmt.PUT("/generic-secrets", s.mgmt.PutGenericSecrets)
		mgmt.PATCH("/generic-secrets/:id", s.mgmt.PatchGenericSecret)
		mgmt.DELETE("/generic-secrets/:id", s.mgmt.DeleteGenericSecret)
		mgmt.GET("/account-matrix", s.mgmt.GetAccountMatrix)
		mgmt.GET("/codex-rate-limits", s.mgmt.CodexRateLimits)
		...
		mgmt.PATCH("/auth-files/pause", s.mgmt.PatchAuthFilePause)
